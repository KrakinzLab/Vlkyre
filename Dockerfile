...
RUN git clone https://github.com/gascomit/Vlkyre.git 
RUN cd Vlkyre
WORKDIR /Vlkyre
...
RUN git config --global user.name 'GasComIT' && git config --global user.email 'may_feed@aol.com' && git config pull.rebase false 
